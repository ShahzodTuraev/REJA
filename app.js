...
app.post("/delete-item", (req, res) => {
  ...
  console.log("delete", new mongodb.ObjectId(id));
  db.collection("plans").deleteOne(
    { _id: new mongodb.ObjectId(id) }, // idni mongodbning mongodb id siga o'tkazildi, mongo db idni qiymatidan tashqari typesini ham talab qiladi.
    (err, data) => {
...
app.post("/edit-item", (req, res) => {
  ...
  db.collection("plans").findOneAndUpdate(
    ...
    { $set: { reja: data.new_input } }, //data-axios dagi object
    (err, data) => {
      res.json({ state: "success" });
    }
  );
